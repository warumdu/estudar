...
test('App-Hülle liegt vollständig im Cache', async () => {
  ...
  for (const p of ['/estudar/', '/estudar/index.html', '/estudar/manifest.webmanifest', '/estudar/app/main.js', '/estudar/app/style.css', '/estudar/vendor/ts-fsrs/index.js', '/estudar/diagnose.html', '/estudar/app/diagnose.js', '/estudar/app/speech.js', '/estudar/icons/icon-180.png', '/estudar/icons/icon-192.png', '/estudar/icons/icon-512.png', '/estudar/icons/icon-512-maskable.png', '/estudar/icons/favicon-32.png']) {
